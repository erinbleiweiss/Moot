...
class ScoreBox: UIView{
    ...
    override init(frame: CGRect){
        ...
        self.pointsLabel = UILabel(frame: CGRect(x: 0, y: self.bounds.height * 0.4, width: self.bounds.width, height: self.bounds.height * 0.6))
        ...
        self.mootPointsLabel = UILabel(frame: CGRect(x: 0, y: 0, width: self.bounds.width, height: self.bounds.height * 0.4))
