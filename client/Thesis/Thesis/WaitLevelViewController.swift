...
class WaitLevelViewController: GenericLevelViewController, CLLocationManagerDelegate {
    ...
    let controller: WaitGameController
    required init?(coder aDecoder: NSCoder){
        controller = WaitGameController()
